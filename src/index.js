 ...
 */
export const runFunctionAtSameTimeEveryDay = (hour, minute, second, callback) => {
 ...
 * @returns {null}
 */
const Scheduler = ({ onExecute, hour, minute, second, }) => {
    useEffect(() => runFunctionAtSameTimeEveryDay(hour, minute, second, onExecute), [onExecute, hour, minute, second]);
    return null;
};
Scheduler.propTypes = {
